...
from tensorflow.keras.layers import Input, Conv2D, Dense, Dropout, Activation, Flatten, GlobalMaxPooling2D
...
def Conv2DModel(model_name, input_shape, kernel_col, kernels=64, kernel_rows=3, learning_rate=0.01, regularization=None, dropout=None, weight_decay=0.0):
    ...
    if args.train is not None:
        ...
        for full_path in tqdm(subfolders, desc="Processing Folders"):
            ...
            keras_classifier = KerasClassifier(
                ...
                learning_rate=0.01, kernels=64, regularization=None, dropout=None, weight_decay=0.0
            )
    ...
    if args.predict is not None:
        ...
        with open(predict_filepath, 'w', newline='') as predict_file:
            ...
            for dataset_path in tqdm(dataset_filelist, desc="Predicting on test files"):
                ...
                # --- Critical Fix: Data Types and Label Shapes ---
